 ...
 * @see Templating rich text and title fields from Prismic {@link https://prismic.io/docs/technologies/templating-rich-text-and-title-fields-javascript}
 */
declare const asText: <Field extends [] | [_prismicio_types.RTNode, ..._prismicio_types.RTNode[]] | null | undefined>(richTextField: Field, separator?: string) => AsTextReturnType<Field>;
 ...
 * @see Templating rich text and title fields from Prismic {@link https://prismic.io/docs/technologies/templating-rich-text-and-title-fields-javascript}
 */
declare const asHTML: <Field extends [] | [_prismicio_types.RTNode, ..._prismicio_types.RTNode[]] | null | undefined>(richTextField: Field, linkResolver?: LinkResolverFunction<string> | null, htmlSerializer?: HTMLFunctionSerializer | HTMLMapSerializer | null) => AsHTMLReturnType<Field>;
 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
declare const image: <ThumbnailNames extends string | null = never>(field: ((_prismicio_types.EmptyImageFieldImage & Record<Exclude<Extract<ThumbnailNames, string>, "url" | "dimensions" | "alt" | "copyright">, _prismicio_types.EmptyImageFieldImage | _prismicio_types.FilledImageFieldImage> extends infer T ? { [P in keyof T]: (_prismicio_types.EmptyImageFieldImage & Record<Exclude<Extract<ThumbnailNames, string>, "url" | "dimensions" | "alt" | "copyright">, _prismicio_types.EmptyImageFieldImage | _prismicio_types.FilledImageFieldImage>)[P]; } : never) | (_prismicio_types.FilledImageFieldImage & Record<Exclude<Extract<ThumbnailNames, string>, "url" | "dimensions" | "alt" | "copyright">, _prismicio_types.EmptyImageFieldImage | _prismicio_types.FilledImageFieldImage> extends infer T_1 ? { [P_1 in keyof T_1]: (_prismicio_types.FilledImageFieldImage & Record<Exclude<Extract<ThumbnailNames, string>, "url" | "dimensions" | "alt" | "copyright">, _prismicio_types.EmptyImageFieldImage | _prismicio_types.FilledImageFieldImage>)[P_1]; } : never)) | null | undefined) => field is _prismicio_types.FilledImageFieldImage & Record<Exclude<Extract<ThumbnailNames, string>, "url" | "dimensions" | "alt" | "copyright">, _prismicio_types.FilledImageFieldImage> extends infer T_2 ? { [P_2 in keyof T_2]: (_prismicio_types.FilledImageFieldImage & Record<Exclude<Extract<ThumbnailNames, string>, "url" | "dimensions" | "alt" | "copyright">, _prismicio_types.FilledImageFieldImage>)[P_2]; } : never;
/**
 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
declare const link: <TypeEnum = string, LangEnum = string, DataInterface extends Record<string, AnyRegularField | [Record<string, AnyRegularField>, ...Record<string, AnyRegularField>[]] | [Slice<string, Record<string, AnyRegularField>, Record<string, AnyRegularField>> | SharedSlice<string, _prismicio_types.SharedSliceVariation<string, Record<string, AnyRegularField>, Record<string, AnyRegularField>>>, ...(Slice<string, Record<string, AnyRegularField>, Record<string, AnyRegularField>> | SharedSlice<string, _prismicio_types.SharedSliceVariation<string, Record<string, AnyRegularField>, Record<string, AnyRegularField>>>)[]]> = never>(field: _prismicio_types.EmptyLinkField<"Any"> | _prismicio_types.FilledLinkToWebField | _prismicio_types.FilledLinkToMediaField | _prismicio_types.FilledContentRelationshipField<TypeEnum, LangEnum, DataInterface> | null | undefined) => field is _prismicio_types.FilledLinkToWebField | _prismicio_types.FilledLinkToMediaField | _prismicio_types.FilledContentRelationshipField<TypeEnum, LangEnum, DataInterface>;
/**
 ...
 * @returns `true` if `field` is filled, `false` otherwise.
 */
declare const integrationFields: <Data extends Record<string, unknown>>(field: Data | null | undefined) => field is Data;
/**
